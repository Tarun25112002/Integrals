          ...
          <div className="text-center">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="#"
                  className="text-gray-300 hover:text-white hover:font-semibold transition-all duration-200"
                >
                  Dashboard
                </a>
              </li>
        ...
        <div className="border-t border-gray-700 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 text-sm">
              ...
              <span className="text-gray-400">for educators worldwide</span>
            </div>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-800 text-center">
            <div className="flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-8 text-sm text-gray-400">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>Trusted by 100+ Educators</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg
